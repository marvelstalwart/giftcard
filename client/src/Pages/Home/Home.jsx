...
import MinatureCard from './components/MinatureCard';
        ...
        <div className='flex justify-between'>
         ...
         <div>
          <form className='flex flex-col gap-4 h-full '>
           ...
           {showConfirmation ? <ConfirmationForm handleConfirmation={handleConfirmation}  handleChange={handleChange} forms={forms} selectedCard={selectedCard} formValues={formValues} defaultDate={defaultDate}/>: null} 
          </div>
    {/* <ul>
